...
def predImage(index, model, device):
    datas = dataloader(index, config['data_loader']['args']['data_dir'])
    ...
    save_image("new_output", original_input.numpy(), intersection.numpy(), f'image_{index}')
